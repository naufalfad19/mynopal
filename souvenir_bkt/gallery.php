...
<body onload="init();detsou('<?php echo $_GET["idgallery"] ?>');">
  ...
  <section id="container" >
    <header class="header black-bg">
      ...
      <!--logo start-->
       <a class="logo" ><p><img src=""><font face="Courier New">WebGis Souvenir (19 1811522021 Naufal Fadilan)</font> </p></a>
        <div class="top-menu">
                  ...
                  <section class="panel">
                    ...
                    <?php 
                     ...
                     // echo "ini $id";
                      ...
                      $result = pg_query($conn, $sqlreview);
                  ...
                  <div class="col-sm-12"> <!-- gallery -->
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <div class="html5gallery" style=" max-height:470px; display:block; width: 100%;" data-skin="horizontal"  data-height="280" data-width="400" data-resizemode="fit" > 
                            ...
                            if (strpos($id,"H") !== false) {  //Hotel
                              ...
                              $hasil=pg_query($conn, $querysearch);
                              while($baris = myqli_fetch_assoc($hasil)){
             ...
             for (var i in rows) 
              { 
                ...
                map.setZoom(18); 
                    ...
                    if(i==0){
                      $('#detgal').append("<tr><td>Name</td><td>:</td><td> "+name+"</td></tr><br><tr><td>address</td><td>:</td><td> "+address+"</td></tr><br><tr><td>Phone</td><td>:</td><td> "+cp+"</td></tr><br><tr><td>Owner</td><td>:</td><td> "+owner+"</td></tr><br><tr><td>Place's Status</td><td>:</td><td> "+status+"</td></tr><br><tr><td>Type</td><td>:</td><td> "+type+"</td></tr><tr><td><b> Product </b></td><td></td><td><b> Price </b></td></tr>");
                    }
...
function posisisekarang()
{
  ...
  navigator.geolocation.getCurrentPosition(function(position)
  {
    ...
    function setLastPos(latitude, longitude, name){
        ...
        // alert(rad_lat);
        alert("Anda sekarang berada di "+latitude+", "+longitude);
      }
